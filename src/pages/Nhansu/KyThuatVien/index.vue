<template>
  <v-container fluid>
    <v-list-item three-line>
      <v-layout>
        <v-img max-height="100" max-width="100" :size="40" :src="NhanVienPic" class="mr-4"></v-img>
        <v-list-item-content>
          <v-list-item-title class="headline mb-1">
            KỸ THUẬT VIÊN</v-list-item-title>
          <v-list-item-subtitle>Danh sách nhân sự kỹ thuật viên</v-list-item-subtitle>
        </v-list-item-content>
...
import NhanVienPic from "../../../assets/images/kyThuatVien.svg";
